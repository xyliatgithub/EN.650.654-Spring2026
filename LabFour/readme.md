...
## Lab Instructions 
Please complete the lab tasks of **2.1, 2.3, and 2.4** in Section 2 (2.2 is not required so you only need to use UFW) following [this page](Firewall.pdf). You also need to finish the **additional tasks** described below.
